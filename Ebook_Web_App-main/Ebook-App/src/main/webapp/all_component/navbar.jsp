...
<div class="container-fluid p-3">
	<div class="row">
		<div class="col-md-3 text-success">
			<h3>
				<i class="fa-solid fa-book"></i> Web-Novels
			</h3>
		</div>
		<div class="col-md-6">
		...
		<c:if test="${not empty userobj}">
			...
			<a href="checkout.jsp" ><i class="fa-solid fa-cart-plus fa-2x mt-1"></i></a>
				...
				<a href="login.jsp
			" class="btn btn-success"><i class="fa-solid fa-user-plus"> ${userobj.name}</i> </a> 
		...
		<c:if test="${empty userobj}">
			...
			" class="btn btn-success"> <i
				...
				</a> <a href="register.jsp" class="btn btn-primary text-white">
